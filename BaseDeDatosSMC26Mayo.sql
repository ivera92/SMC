...
/* Created on:     26/05/2017 18:59:12                          */
/*==============================================================*/
...
if exists (select 1
   from sys.sysreferences r join sys.sysobjects o on (o.id = r.constid and o.type = 'F')
   where r.fkeyid = object_id('ASIGNATURA') and o.name = 'FK_ASIGNATU_EVALUA_EVALUACI')
alter table ASIGNATURA
   drop constraint FK_ASIGNATU_EVALUA_EVALUACI
go
...
if exists (select 1
   from sys.sysreferences r join sys.sysobjects o on (o.id = r.constid and o.type = 'F')
   where r.fkeyid = object_id('COMPETENCIA') and o.name = 'FK_COMPETEN_RELATIONS_TIPO_COM')
alter table COMPETENCIA
   drop constraint FK_COMPETEN_RELATIONS_TIPO_COM
go

if exists (select 1
   from sys.sysreferences r join sys.sysobjects o on (o.id = r.constid and o.type = 'F')
   where r.fkeyid = object_id('CURSA') and o.name = 'FK_CURSA_CURSA_ASIGNATU')
alter table CURSA
   drop constraint FK_CURSA_CURSA_ASIGNATU
go

if exists (select 1
   from sys.sysreferences r join sys.sysobjects o on (o.id = r.constid and o.type = 'F')
   where r.fkeyid = object_id('CURSA') and o.name = 'FK_CURSA_ES_CURSAD_ALUMNO')
alter table CURSA
   drop constraint FK_CURSA_ES_CURSAD_ALUMNO
go
...
if exists (select 1
           ...
           where  id    = object_id('ASIGNATURA')
            ...
            and   indid > 0
            and   indid < 255)
   drop index ASIGNATURA.EVALUA_FK
go
...
if exists (select 1
           ...
           where  id    = object_id('COMPETENCIA')
            ...
            and   indid > 0
            and   indid < 255)
   drop index COMPETENCIA.RELATIONSHIP_19_FK
go
...
if exists (select 1
            from  sysindexes
           where  id    = object_id('CURSA')
            and   name  = 'CURSA_FK'
            and   indid > 0
            and   indid < 255)
   drop index CURSA.CURSA_FK
go
...
if exists (select 1
           ...
           where  id    = object_id('CURSA')
            ...
            and   indid > 0
            and   indid < 255)
   drop index CURSA.ES_CURSADA_FK
go
...
if exists (select 1
            from  sysobjects
           where  id = object_id('TIPO_COMPETENCIA')
            and   type = 'U')
...
create table ALUMNO (
   ...
   CORREO_ALUMNO        varchar(60)          not null,
...
create table ASIGNATURA (
   ...
   ID_EVALUACION_ASIGNATURA int                  null,
   NOMBRE_EVALUACION_ASIGNATURA varchar(60)          null,
   ...
   constraint PK_ASIGNATURA primary key nonclustered (COD_ASIGNATURA)
)
go
...
/* Index: EVALUA_FK                                             */
/*==============================================================*/
create index EVALUA_FK on ASIGNATURA (
ID_EVALUACION_ASIGNATURA ASC,
NOMBRE_EVALUACION_ASIGNATURA ASC
)
go
...
create table ASIGNATURA_COMPETENCIA (
   ID_AC                int                  identity,
   COD_ASIGNATURA_AC    varchar(15)          not null,
   ID_COMPETENCIA_AC    int                  not null,
   constraint PK_ASIGNATURA_COMPETENCIA primary key (ID_AC, COD_ASIGNATURA_AC, ID_COMPETENCIA_AC)
)
go
...
/*==============================================================*/
create index RELATIONSHIP_19_FK on COMPETENCIA (
ID_TIPO_COMPETENCIA ASC
)
go
...
create table CURSA (
   ...
   COD_ASIGNATURA_AA    varchar(15)          not null,
   constraint PK_CURSA primary key (RUT_ALUMNO_AA, COD_ASIGNATURA_AA, ID_AA)
)
go
...
/* Index: ES_CURSADA_FK                                         */
/*==============================================================*/
create index ES_CURSADA_FK on CURSA (
RUT_ALUMNO_AA ASC
)
go
...
/* Index: CURSA_FK                                              */
/*==============================================================*/
create index CURSA_FK on CURSA (
COD_ASIGNATURA_AA ASC
)
go
...
create table EVALUACION (
   ...
   COD_ASIGNATURA_EVALUACION varchar(15)          not null,
   FECHA_EVALUACION     datetime             null,
   PREGUNTAS_EVALUACION varchar(100)         null,
   constraint PK_EVALUACION primary key nonclustered (ID_EVALUACION, NOMBRE_EVALUACION)
)
go
...
create table HISTORICO_PRUEBA_ALUMNO (
   ...
   NOMBRE_EVALUACION_HPA varchar(60)          not null,
...
create table PERSONA (
   ...
   CORREO_PERSONA       varchar(60)          not null,
...
create table PREGUNTA (
   ...
   ENUNCIADO_PREGUNTA   varchar(8000)        null,
   IMAGEN_PREGUNTA      varchar(150)         null,
   NIVEL_PREGUNTA       char(3)              null,
...
/*==============================================================*/
/* Table: TIPO_COMPETENCIA                                      */
/*==============================================================*/
create table TIPO_COMPETENCIA (
   ID_TIPO_COMPETENCIA  int                  identity,
   NOMBRE_TIPO_COMPETENCIA varchar(45)          null,
   constraint PK_TIPO_COMPETENCIA primary key nonclustered (ID_TIPO_COMPETENCIA)
)
go
...
create table USUARIO (
   ...
   ID_TIPO_USUARIO_USUARIO int                  null,
...
alter table ASIGNATURA
   add constraint FK_ASIGNATU_EVALUA_EVALUACI foreign key (ID_EVALUACION_ASIGNATURA, NOMBRE_EVALUACION_ASIGNATURA)
      references EVALUACION (ID_EVALUACION, NOMBRE_EVALUACION)
go
...
alter table ASIGNATURA_COMPETENCIA
   add constraint FK_ASIGNATU_ESTA_ASOC_ASIGNATU foreign key (COD_ASIGNATURA_AC)
...
alter table COMPETENCIA
   add constraint FK_COMPETEN_RELATIONS_TIPO_COM foreign key (ID_TIPO_COMPETENCIA)
      references TIPO_COMPETENCIA (ID_TIPO_COMPETENCIA)
go

alter table CURSA
   add constraint FK_CURSA_CURSA_ASIGNATU foreign key (COD_ASIGNATURA_AA)
      references ASIGNATURA (COD_ASIGNATURA)
go

alter table CURSA
   add constraint FK_CURSA_ES_CURSAD_ALUMNO foreign key (RUT_ALUMNO_AA)
...
alter table EVALUACION
   add constraint FK_EVALUACI_ES_EVALUA_ASIGNATU foreign key (COD_ASIGNATURA_EVALUACION)
      references ASIGNATURA (COD_ASIGNATURA)
go
...
alter table HISTORICO_PRUEBA_ALUMNO
   add constraint FK_HISTORIC_RELATIONS_EVALUACI foreign key (ID_EVALUACION_HPA, NOMBRE_EVALUACION_HPA)
      references EVALUACION (ID_EVALUACION, NOMBRE_EVALUACION)
go
...
alter table USUARIO
   add constraint FK_USUARIO_RELATIONS_TIPO_USU foreign key (ID_TIPO_USUARIO_USUARIO)
