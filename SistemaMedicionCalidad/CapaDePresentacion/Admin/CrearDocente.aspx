...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <div class="row">
        ...
        <div class="col-sm-4"><asp:TextBox ID="nombre" class="form-control" runat="server" pattern="^([A-ZÁÉÍÓÚ]{1}[a-zñáéíóú]+[\s]*)+$" placeHolder="Ingrese su nombre" 
    ...
    <div class="row">
        ...
        <div class="col-sm-4"><asp:TextBox ID="rut" class="form-control" runat="server" placeHolder="Ejemplo: 18205857-2" ></asp:TextBox></div>
    </div>
    <br />
    ...
    <div class="row">
        ...
        <div class="col-sm-4"><asp:TextBox ID="fechaDeNacimiento" class="form-control" runat="server" type="date" format="data-fv-date-format"></asp:TextBox></div>
    </div>
    <br />

    <div class="row">
        <div class="col-sm-offset-3 col-sm-2"><label>Profesion</label></div>
        <div class="col-sm-4"><asp:DropDownList ID="profesion" runat="server" class="form-control"></asp:DropDownList></div>
    </div>
    <br />
