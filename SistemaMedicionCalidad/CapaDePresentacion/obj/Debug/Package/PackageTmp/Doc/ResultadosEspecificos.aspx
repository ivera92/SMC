<%@ Page Title="" Language="C#" MasterPageFile="~/Doc/SiteDocente.Master" AutoEventWireup="true" CodeBehind="ResultadosEspecificos.aspx.cs" Inherits="CapaDePresentacion.Doc.ResultadosEspecificos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="row">
        <div class="col-sm-12">
            <asp:Image ID="rEE" runat="server" ImageUrl="ImagenesDoc/rEE.PNG" />
            <div>
                <div class="col-sm-3">
                    <br />
                ...
                <div class="col-sm-1">
                    <br />
                    <br />
                    <asp:Button ID="btnVer" runat="server" Text="Ver" CssClass="form-control btn-block" ForeColor="White" BackColor="#7F1734" BorderColor="White" OnClick="btnVer_Click" />
                </div>
                ...
                <div class="col-sm-12">
                    <asp:Panel ID="panelGrafico" runat="server" CssClass="table  table-bordered table-condensed table-responsive">
                ...
                <div class="col-sm-12">
                    ...
                    <asp:GridView ID="gvDesempenos" runat="server" AutoGenerateColumns="false" CssClass="table table-striped" BackColor="White">
                        <HeaderStyle Font-Bold="True" ForeColor="White" BackColor="#7F1734" BorderColor="White" />
                        <Columns>
