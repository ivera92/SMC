...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server"><div class="row">
        <div class="col-sm-offset-4 col-sm-4">
            <asp:Image ID="cClave" runat="server" ImageUrl="ImagenesAdmin/cClave.PNG" />
            <div class="col-sm-12" style="border: solid 1px #ccc">
                ...
                <div class="col-sm-offset-2 col-sm-8">
                    <asp:Button ID="btnGuardar" runat="server" Text="Guardar" class="btn btn-block btn-success" OnClick="btnGuardar_Click" />
                    <br />
                </div>
            </div>
