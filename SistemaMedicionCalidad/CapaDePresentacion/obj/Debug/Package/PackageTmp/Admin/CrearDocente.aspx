    ...
    <div id="crear" runat="server">
        ...
        <div class="row">
            <div class="col-sm-offset-3 col-sm-2">
                <label>Rut</label></div>
            <div class="col-sm-4">
                <asp:TextBox ID="txtRut" class="form-control" runat="server" placeHolder="Ejemplo: 18205857-2"></asp:TextBox></div>
        </div>
        <br />
        ...
        <div class="row">
            <div class="col-sm-2 col-sm-offset-7">
                <asp:Button ID="btnCrear" class="btn btn-primary btn-block" runat="server" Text="Crear" OnClick="btnCrear_Click" /></div>
        </div>
    </div>
</asp:Content>
