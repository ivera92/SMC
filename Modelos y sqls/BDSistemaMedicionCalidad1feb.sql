...
create table ALUMNO (
   ...
   DIRECCION_ALUMNO     varchar(60)          null,
...
create table ASIGNATURA_COMPETENCIA (
   ...
   constraint PK_ASIGNATURA_COMPETENCIA primary key (ID_AC)
)
go
...
create table DOCENTE (
   ...
   DIRECCION_DOCENTE    varchar(60)          null,
...
create table ESCUELA (
   ...
   NOMBRE_ESCUELA       varchar(60)          null,
...
create table PERSONA (
   ...
   DIRECCION_PERSONA    varchar(60)          null,
   TELEFONO_PERSONA     int                  null,
   SEXO_PERSONA         bit                  null,
   CORREO_PERSONA       varchar(45)          null,
...
create table PREGUNTA (
   ...
   NOMBRE_PREGUNTA      varchar(80)          null,
...
create table RESPUESTA (
   ...
   NOMBRE_RESPUESTA     varchar(45)          null,
...
create table TIPO_PREGUNTA (
   ...
   NOMBRE_TIPO_PREGUNTA varchar(30)          null,
